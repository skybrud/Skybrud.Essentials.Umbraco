...
/// <summary>
/// Static class with constants for Umbraco media types.
/// </summary>
public static class UmbracoMediaTypes {

    /// <summary>
    /// Gets the alias of the <strong>Article</strong> media type.
    /// </summary>
