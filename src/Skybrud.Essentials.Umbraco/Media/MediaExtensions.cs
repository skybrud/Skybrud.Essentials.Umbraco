...
public static class MediaExtensions {
    ...
    /// <param name="helper">An <see cref="IMediaHelper"/> instance.</param>
    /// <param name="file">An uploaded file.</param>
    public static void SetValue(this IMedia media, IMediaHelper helper, IFormFile file) {
    ...
    public static void SetValue(this IMedia media, IMediaHelper helper, IFormFile file, string fileName) {
    ...
    public static void SetValue(this IMedia media, IMediaHelper helper, Stream stream, string fileName) {
