...
public static class UmbracoPropertyEditorUiAliases {
    ...
    public const string EmailAddress = "Umb.PropertyEditorUi.EmailAddress";

    // Boolean
    public const string Toggle = "Umb.PropertyEditorUi.Toggle";

    // Numbers
    public const string Integer = "Umb.PropertyEditorUi.Integer";
    public const string Decimal = "Umb.PropertyEditorUi.Decimal";
    public const string Slider = "Umb.PropertyEditorUi.Slider";

    // Date & Time
    public const string DatePicker = "Umb.PropertyEditorUi.DatePicker";

    // Colors
    public const string ColorPicker = "Umb.PropertyEditorUi.ColorPicker";
    public const string EyeDropper = "Umb.PropertyEditorUi.EyeDropper";

    // Lists
    public const string Dropdown = "Umb.PropertyEditorUi.Dropdown";
    public const string Select = "Umb.PropertyEditorUi.Select";
    public const string RadioButtonList = "Umb.PropertyEditorUi.RadioButtonList";
    public const string CheckBoxList = "Umb.PropertyEditorUi.CheckBoxList";
    public const string MultipleTextString = "Umb.PropertyEditorUi.MultipleTextString";
    ...
    public const string MemberPicker = "Umb.PropertyEditorUi.MemberPicker";
    public const string MemberGroupPicker = "Umb.PropertyEditorUi.MemberGroupPicker";
    ...
    public const string BlockGrid = "Umb.PropertyEditorUi.BlockGrid";

    // Misc
    public const string Label = "Umb.PropertyEditorUi.Label";
    ...
    public const string OverlaySize = "Umb.PropertyEditorUi.OverlaySize";
    public const string OrderDirection = "Umb.PropertyEditorUi.OrderDirection";
