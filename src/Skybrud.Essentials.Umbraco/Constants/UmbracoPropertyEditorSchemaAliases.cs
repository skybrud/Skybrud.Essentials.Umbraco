...
public static class UmbracoPropertyEditorSchemaAliases {
    ...
    // Boolean
    public const string Toggle = "Umbraco.TrueFalse";
    ...
    // Date & Time
    public const string DatePicker = "Umbraco.DateTime";
    ...
    public const string DocumentPicker = "Umbraco.ContentPicker";
    public const string MediaPicker = "Umbraco.MediaPicker3";
